...
-- CREATE INDEX IF NOT EXISTS idx_clicks_clicked_at ON url_clicks(clicked_at DESC);
-- CREATE INDEX IF NOT EXISTS idx_clicks_country ON url_clicks(country_code) WHERE country_code IS NOT NULL;
...
-- DROP TRIGGER IF EXISTS trigger_increment_click_count ON url_clicks;
